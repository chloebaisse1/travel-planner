          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                Planifiez le voyage parfait, à chaque fois.
              </h1>
              <p className="text-xl md:text-2xl text-gray-600 mb-8">
                Créez des itinéraires, organisez vos destinations et partagez
                vos plans de voyage, le tout au même endroit.
              </p>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="p-6 rounded-lg border border-gray-100 shadow-sm bg-white">
                ...
                <p className="text-gray-600">
                  Visualisez votre voyage grâce à des cartes interactives.
                  Consultez tout votre itinéraire en un coup d’œil.
                </p>
              </div>
              <div className="p-6 rounded-lg border border-gray-100 shadow-sm bg-white">
                ...
                <p className="text-gray-600">
                  Organisez votre voyage jour après jour. Ne manquez rien grâce
                  à une planification structurée
                </p>
              </div>
              <div className="p-6 rounded-lg border border-gray-100 shadow-sm bg-white">
                ...
                <p className="text-gray-600">
                  Réorganisez facilement votre itinéraire grâce à la
        ...
        <section className="py-16 md:py-24 bg-gray-800">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Prêt(e) à planifier votre prochaine aventure ?
            </h2>
            <p className="text-xl text-blue-50 mb-8 max-w-2xl mx-auto">
              Rejoignez des milliers de voyageurs qui organisent de meilleurs
            ...
            >
              {isLoggedIn ? "Essayez-le" : "Inscrivez-vous"}
            </AuthButton>
          </div>
        </section>
      </main>
